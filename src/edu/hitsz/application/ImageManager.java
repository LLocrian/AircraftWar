...
public class ImageManager {
    ...
    public static BufferedImage RECOVER_SUPPLY_IMAGE;
    ...
    static {
        try {
            ...
            RECOVER_SUPPLY_IMAGE = ImageIO.read(new FileInputStream("src/images/prop_blood.png"));
            ...
            CLASSNAME_IMAGE_MAP.put(RecoverSupply.class.getName(), RECOVER_SUPPLY_IMAGE);
