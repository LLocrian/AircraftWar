...
import edu.hitsz.supply.RecoverSupply;
...
public class Game extends JPanel {
    ...
    private final List<BaseSupply> allSupply;
    ...
    private void supplyMoveAction() {
        for(BaseSupply supply: allSupply) {
            supply.forward();
        }
    }
    ...
    private void postProcessAction() {
        ...
        allSupply.removeIf(AbstractFlyingObject::notValid);
    }
    ...
    public void paint(Graphics g) {
        ...
        for(AbstractFlyingObject bullet: heroBullets) {
            g.drawImage(
                    ImageManager.HERO_BULLET_IMAGE,
                    bullet.getLocationX(),
                    bullet.getLocationY(),
                    null
            );
        }
        for(AbstractFlyingObject supply: allSupply) {
            g.drawImage(
                    ImageManager.get(supply),
                    supply.getLocationX(),
                    supply.getLocationY(),
                    null
            );
